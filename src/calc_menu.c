...
static void initialise_ui(void) {
  ...
  text_layer_set_text_alignment(s_textlayer_subtotal, GTextAlignmentLeft);
  ...
  text_layer_set_text_alignment(s_textlayer_service, GTextAlignmentLeft);
  ...
  text_layer_set_text_alignment(s_textlayer_tip_pct, GTextAlignmentLeft);
